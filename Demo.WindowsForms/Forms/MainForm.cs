...
namespace Demo.WindowsForms
{
   public partial class MainForm : Form
   {
      ...
      // polygons
      GMapPolygon polygon;
      readonly PointLatLng gtl = new PointLatLng(30, 117);
      readonly PointLatLng gbr = new PointLatLng(28, 119);
      ...
      public MainForm()
      {
         ...
         if(!DesignMode)
         {
            ...
            MainMap.Manager.Mode = AccessMode.CacheOnly;
            // config map 
            MainMap.Position = new PointLatLng(59.6961334816182, 118.9985095977783);
            MainMap.MapType = MapType.GoogleSatelliteChina;
            MainMap.MinZoom = 1;
            MainMap.MaxZoom = 17;
            MainMap.Zoom = 9;
            MainMap.MapName = "千岛湖实验区域地图";
            // map events
