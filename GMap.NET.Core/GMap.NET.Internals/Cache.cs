      ...
      public Cache()
      {
         ...
         if(string.IsNullOrEmpty(CacheLocation))
         {
...
#endif
            {
               ...
               string newCache = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().GetModules()[0].FullyQualifiedName) 
                   + Path.DirectorySeparatorChar + "MapCache" + Path.DirectorySeparatorChar; ;//modified by john 2011/10/26
