...
namespace GMap.NET.WindowsForms
{
...
#endif
   {
      ...
      /// </summary>
#if !PocketPC
      public Font Font = new Font(FontFamily.GenericSerif, 14, FontStyle.Bold, GraphicsUnit.Pixel);
#else
      ...
      /// text foreground
      /// </summary>
      public Brush Foreground = new SolidBrush(Color.FromArgb(222, Color.AliceBlue));
